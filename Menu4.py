...
def main(test: bool = False) -> None:
    ...
    range_values_discrete = {0: 'EASY', 1: 'MEDIUM', 2: 'HARD'}
    play_menu.add.range_slider('Choose difficulty', 0, list(range_values_discrete.keys()), slider_text_value_enabled=False, value_format=lambda x: range_values_discrete[x])
#Прописать определение уровня
    ...
    myimage = pygame_menu.baseimage.BaseImage(image_path="D:\\Education\\MIPT\\English\\how to cope with stress\\фон.jpg")
    main_theme.background_color = myimage
